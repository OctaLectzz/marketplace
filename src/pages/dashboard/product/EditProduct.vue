    ...
    <q-form @submit="editData">
      <q-card style="min-width: 400px">
        <q-card-section class="row items-center q-py-sm">
          <div class="text-h6">Edit Produk</div>
          <q-space />
        ...
        <q-card-section class="scroll" style="height: 77vh">
          <div class="row justify-center">
            ...
            <div class="col-md-3 col-xs-10 q-ma-md">
              <div class="text-bold">Tambah Foto Produk :</div>
              <q-uploader v-model="photos" label="Tambah Foto Produk" style="width: 100%; min-height: 470px" @added="photosAdded" multiple batch />
            </div>
...
const selectedCategory = ref(item.category)
...
const editData = async () => {
  ...
  try {
    ...
    $q.notify({
      message: error.response.data.message || 'Produk gagal diedit, Silahkan coba lagi nanti',
      icon: 'warning',
      color: 'negative'
    })
  }
